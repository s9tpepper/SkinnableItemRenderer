...
//  All Rights Reserved.
//
//	Modified by: Omar Gonzalez (omar@almerblank.com :: http://labs.almerblank.com :: http://omar.likesflex.com)
//
...
package almerblank.flex.spark.components
{
	 ...
	 */
	public class SkinnableItemRenderer extends SkinnableDataRenderer implements IItemRenderer
	{    
		//--------------------------------------------------------------------------
		//
		//  Constructor
		...
		public function set autoDrawBackground(value:Boolean):void
		{
			...
			{
				// Methods lost from not extending Group and extending SkinnableComponent instead
